\documentclass[SE,lsstdraft]{lsstdoc}

\setDocChangeRecord{%
\addtohist{1.0}{2018-01-25}{Initial formal version after LCR-1214 process.} {G.P.~Dubois-Felsmann}
}
...
\begin{itemize}
\item In presentations and external communications in general (interviews, press releases, newspaper articles, etc.);
\item In documents and documentation meant to be read by the community (data product descriptions, science platform documentation, etc);
